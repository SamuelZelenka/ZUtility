    ...
    class Grid
    {
        ...
        public Grid(int width, int height, float cellSize, Vector3 originPosition)
        {
            ...
            for (int x = 0; x < gridArray.GetLength(0); x++)
            {
                ...
                {
                    debugTextArray[x, y] = TextUtility.CreateWorldText(null, gridArray[x, y].ToString(), GetWorldPosition(x, y) + new Vector3(cellSize, cellSize) * .5f, 20, Color.white, TextAnchor.MiddleCenter, TextAlignment.Center);
